  ...
  return ( 
    ...
    <div className={`relative bg-zinc-900/30 border ${isDivine ? 'border-purple-900/50' : 'border-red-900/50'} rounded-lg p-4 mb-4 shadow-md group transition-all`}> 
      ...
      <div className="flex justify-between items-start mb-3 pr-12"> 
        ...
        {cost && ( 
          <div className={`${isDivine ? 'bg-purple-950/40 border-purple-900/50 text-purple-400' : 'bg-amber-950/40 border-amber-900/50 text-amber-500'} border px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase whitespace-nowrap shadow-inner`}>
            {cost}
          </div> 
        )} 
      </div> 
